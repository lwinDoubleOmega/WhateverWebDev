...
<head>
    ...
    <style>
        ...
        nav .logo { font-size: 1.4rem; font-weight: bold; letter-spacing: 2px; }
        ...
        .welcome-banner h2 { margin: 0; font-size: 1.3rem; }
        .welcome-banner span { opacity: 0.6; font-size: 0.9rem; }
        ...
        .stat-card i { font-size: 2rem; color: #1a1a1a; margin-bottom: 10px; }
        ...
        .badge-user  { background: #e8e8e8; color: #555; }
